...
const DriverDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="h-screen bg-black text-white flex flex-col items-center justify-center gap-3">
  ...
  return (
    <div className="h-screen flex flex-col bg-black text-white p-4 md:p-8">
      {/* Header Panel Dashboard Block */}
      <div className="shrink-0 flex items-center justify-between border-b border-white/10 pb-6 mb-8">
        <div>
      ...
      <div className="flex-1 overflow-y-auto pr-2 pb-24 custom-scrollbar">
        ...
        {availableRides.length === 0 ? (
          <div className="flex flex-col items-center justify-center border border-dashed border-white/10 rounded-2xl py-20 px-4 bg-[#0a0a0a] text-center max-w-2xl mx-auto">
            <AlertCircle
              className="text-zinc-600 mb-3 animate-pulse"
              size={36}
            />
